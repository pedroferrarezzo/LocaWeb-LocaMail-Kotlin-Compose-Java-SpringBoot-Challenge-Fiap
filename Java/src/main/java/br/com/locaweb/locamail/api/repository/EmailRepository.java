...
public interface EmailRepository extends JpaRepository<Email, Long> {
    ...
    List<EmailComAlteracao> listarTodosEmails();
    ...
    List<EmailComAlteracao> listarEmailsEnviadosPorRemetente(@Param("remetente") String remetente, @Param("id_usuario") Long id_usuario);
    ...
    List<EmailComAlteracao> listarEmailsPorDestinatario(@Param("id_usuario") Long id_usuario);
    ...
    List<EmailComAlteracao> listarEmailsAi(@Param("id_usuario") Long id_usuario);
    ...
    List<EmailComAlteracao> listarEmailsImportantesPorIdUsuario(@Param("id_usuario") Long id_usuario);
    ...
    List<EmailComAlteracao> listarEmailsSociaisPorIdUsuario(@Param("id_usuario") Long id_usuario);
    ...
    List<EmailComAlteracao> listarEmailsArquivadosPorIdUsuario(@Param("id_usuario") Long id_usuario);
    ...
    List<EmailComAlteracao> listarEmailsSpamPorIdUsuario(@Param("id_usuario") Long id_usuario);
    ...
    List<EmailComAlteracao> listarEmailsLixeiraPorIdUsuario(@Param("id_usuario") Long id_usuario);
    ...
    List<EmailComAlteracao> listarEmailsPorPastaEIdUsuario(@Param("id_usuario") Long id_usuario, @Param("id_pasta") Long id_pasta);
}
