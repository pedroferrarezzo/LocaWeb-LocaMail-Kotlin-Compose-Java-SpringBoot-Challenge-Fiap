...
CREATE TABLE T_LCW_ALTERACAO (
    ...
    excluido NUMBER,
    spam NUMBER,
    CONSTRAINT fk_T_LCW_ALTERACAO_T_LCW_EMAIL FOREIGN KEY (alt_id_email) REFERENCES T_LCW_EMAIL (id_email),
    CONSTRAINT fk_T_LCW_ALTERACAO_T_LCW_PASTA FOREIGN KEY (id_pasta) REFERENCES T_LCW_PASTA (id_pasta),
    CONSTRAINT fk_T_LCW_ALTERACAO_T_LCW_USUARIO FOREIGN KEY (alt_id_usuario) REFERENCES T_LCW_USUARIO (id_usuario)
);
