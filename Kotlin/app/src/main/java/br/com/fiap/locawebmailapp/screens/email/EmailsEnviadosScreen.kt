...
import br.com.fiap.locawebmailapp.utils.api.callLocaMailApiListarEmailsEnviadosPorRemetente
        ...
        callLocaMailApiListarUsuarioSelecionado(
            onSuccess = { usuarioSelecionadoRetornado ->
                ...
                if (usuarioSelecionadoRetornado != null) {
                    ...
                    callLocaMailApiListarEmailsEnviadosPorRemetente(
                        ...
                        onSuccess = { listMailRetornado ->
                            ...
                            if (listMailRetornado != null) {
                                sentEmailList.value = listMailRetornado
                            }
            ...
            ModalNavDrawer(
                ...
                Box(
                    ...
                    Column {
                        ...
                        if (sentEmailList.value.isNotEmpty()) {

                            LazyColumn(reverseLayout = false) {
                                items(sentEmailList.value, key = {
                                    it.id_alteracao
                                }) {
                    ...
                    if (sentEmailList.value.isEmpty()) {
                        Image(
