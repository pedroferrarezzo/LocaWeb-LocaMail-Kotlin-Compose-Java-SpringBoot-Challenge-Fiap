...
import br.com.fiap.locawebmailapp.utils.api.callLocaMailApiListarEmailsArquivadosPorIdUsuario
            ...
            ModalNavDrawer(
                ...
                Box(
                    ...
                    Column {
                        ...
                        if (archiveEmailList.value.isNotEmpty()) {

                            LazyColumn(reverseLayout = false) {
                                items(archiveEmailList.value, key = {
                                    it.id_alteracao
                                }) {
                    ...
                    if (archiveEmailList.value.isEmpty()) {
                        Image(
