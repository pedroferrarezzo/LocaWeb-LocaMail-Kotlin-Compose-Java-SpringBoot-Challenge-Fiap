...
import br.com.fiap.locawebmailapp.utils.api.callLocaMailApiListarEmailsSociaisPorIdUsuario
...
@Composable
fun EmailsSociaisScreen(navController: NavController) {
        ...
        callLocaMailApiListarUsuarioSelecionado(
            onSuccess = { usuarioSelecionadoRetornado ->
                ...
                if (usuarioSelecionadoRetornado != null) {
                    ...
                    callLocaMailApiListarEmailsSociaisPorIdUsuario(
                        usuarioSelecionado.value!!.id_usuario,
                        onSuccess = { listMailSocialRetornado ->

                            isLoading.value = false

                            if (listMailSocialRetornado != null) {
                                socialEmailList.value = listMailSocialRetornado
                            }
            ...
            ModalNavDrawer(
                ...
                Box(
                    ...
                    Column {
                        ...
                        if (socialEmailList.value.isNotEmpty()) {

                            LazyColumn(reverseLayout = false) {
                                items(socialEmailList.value, key = {
                                    it.id_alteracao
                                }) {
                    ...
                    if (socialEmailList.value.isEmpty()) {
                        Image(
