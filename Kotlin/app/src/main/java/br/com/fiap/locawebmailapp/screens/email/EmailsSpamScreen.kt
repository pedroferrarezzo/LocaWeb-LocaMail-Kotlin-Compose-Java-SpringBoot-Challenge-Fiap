...
import br.com.fiap.locawebmailapp.utils.api.callLocaMailApiListarEmailsSpamPorIdUsuario
        ...
        callLocaMailApiListarUsuarioSelecionado(
            onSuccess = { usuarioSelecionadoRetornado ->
                ...
                if (usuarioSelecionadoRetornado != null) {
                    ...
                    callLocaMailApiListarEmailsSpamPorIdUsuario(
                        usuarioSelecionado.value!!.id_usuario,
                        onSuccess = { listMailRetornado ->
                            isLoading.value = false
                            if (listMailRetornado != null) {
                                spamEmailList.value = listMailRetornado
                                spamEmailStateList.addAll(spamEmailList.value)
                            }
                        },
                        onError = {
                            isError.value = true
                    ...
                    Column {
                        ...
                        if (spamEmailStateList.isNotEmpty()) {
                            TopButton(
                                ...
                                onClick = {
                                    for (email in spamEmailList.value) {

                                        callLocaMailApiAtualizarExcluidoPorIdEmailEIdusuario(
                                            true,
                                            email.id_email,
                                            email.alt_id_usuario,
                                            onSuccess = {
                                            },
                                            onError = {
                                                isError.value = true
